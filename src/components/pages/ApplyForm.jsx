    ...
    <div className="min-h-screen p-8 flex justify-center items-center flex-col text-white">
      ...
      {formSubmitted ? (
        ...
        <form
          ...
          className="flex justify-center bg-white items-center flex-col border-white rounded-md border min-h-96 w-full md:w-1/2 p-5 py-10"
        >
          ...
          <button type="submit" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:bg-gradient-to-r hover:from-blue-800 hover:to-indigo-800 font-bold p-2  rounded-md text-white hover:scale-105 border border-white mt-4">
            Submit Application
          </button>
        </form>
      )}
